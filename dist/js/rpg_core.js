...
Point$1.prototype = Object.create(PIXI.Point.prototype);
Point$1.prototype.constructor = Point$1;

Point$1.prototype.initialize = function(x, y) {
 ...
 */
function ResourceHandler$1() {
    throw new Error('This is a static class');
}

ResourceHandler$1._reloaders = [];
ResourceHandler$1._defaultRetryInterval = [500, 1000, 3000];

ResourceHandler$1.createLoader = function(url, retryMethod, resignMethod, retryInterval) {
...
ResourceHandler$1.exists = function() {
    return this._reloaders.length > 0;
};

ResourceHandler$1.retry = function() {
...
Graphics$1._cssFontLoading =  document.fonts && document.fonts.ready;
Graphics$1._fontLoaded = null;
Graphics$1._videoVolume = 1;
 ...
 */
Graphics$1.initialize = function(width, height, type) {
...
Graphics$1._setupCssFontLoading = function(){
    if(Graphics$1._cssFontLoading){
        document.fonts.ready.then(function(fonts){
            Graphics$1._fontLoaded = fonts;
...
Graphics$1.canUseCssFontLoading = function(){
 ...
 */
Graphics$1.render = function(stage) {
 ...
 */
Graphics$1.canUseDifferenceBlend = function() {
 ...
 */
Graphics$1.canUseSaturationBlend = function() {
 ...
 */
Graphics$1.setLoadingImage = function(src) {
 ...
 * @method startLoading
 */
Graphics$1.startLoading = function() {
    this._loadingCount = 0;
};
 ...
 */
Graphics$1.updateLoading = function() {
    this._loadingCount++;
 ...
 * @method endLoading
 */
Graphics$1.endLoading = function() {
 ...
 */
Graphics$1.printLoadingError = function(url) {
 ...
 */
Graphics$1.eraseLoadingError = function() {
    if (this._errorPrinter && !this._errorShowed) {
 ...
 */
Graphics$1.printError = function(name, message) {
 ...
 */
Graphics$1.loadFont = function(name, url) {
 ...
 */
Graphics$1.isFontLoaded = function(name) {
    if (Graphics$1._cssFontLoading) {
        if(Graphics$1._fontLoaded){
            return Graphics$1._fontLoaded.check('10px "'+name+'"');
        }
 ...
 * @param {String} src
 */
Graphics$1.playVideo = function(src) {
    this._videoLoader = ResourceHandler$1.createLoader(null, this._playVideo.bind(this, src), this._onVideoError.bind(this));
    this._playVideo(src);
};
 ...
 * @private
 */
Graphics$1._playVideo = function(src) {
    this._video.src = src;
 ...
 */
Graphics$1.isVideoPlaying = function() {
 ...
 */
Graphics$1.canPlayVideoType = function(type) {
 ...
 * @param {Number} value
 */
Graphics$1.setVideoVolume = function(value) {
 ...
 */
Graphics$1.pageToCanvasX = function(x) {
    if (this._canvas) {
 ...
 */
Graphics$1.pageToCanvasY = function(y) {
    if (this._canvas) {
 ...
 */
Graphics$1.isInsideCanvas = function(x, y) {
 ...
 */
Graphics$1.callGC = function() {
    if (Graphics$1.isWebGL()) {
        Graphics$1._renderer.textureGC.run();
    }
};
 ...
 * @type Number
 */
Object.defineProperty(Graphics$1, 'width', {
    get: function() {
        return this._width;
    },
    set: function(value) {
 ...
 * @type Number
 */
Object.defineProperty(Graphics$1, 'height', {
    get: function() {
        return this._height;
    },
    set: function(value) {
 ...
 * @type Number
 */
Object.defineProperty(Graphics$1, 'boxWidth', {
    get: function() {
 ...
 * @type Number
 */
Object.defineProperty(Graphics$1, 'boxHeight', {
    get: function() {
 ...
 * @type Number
 */
Object.defineProperty(Graphics$1, 'scale', {
    get: function() {
        return this._scale;
    },
    set: function(value) {
 ...
 * @private
 */
Graphics$1._createAllElements = function() {
 ...
 * @private
 */
Graphics$1._updateAllElements = function() {
    this._updateRealScale();
 ...
 * @private
 */
Graphics$1._updateRealScale = function() {
 ...
 * @private
 */
Graphics$1._makeErrorHtml = function(name, message) {
 ...
 * @private
 */
Graphics$1._defaultStretchMode = function() {
 ...
 * @private
 */
Graphics$1._testCanvasBlendModes = function() {
 ...
 * @private
 */
Graphics$1._modifyExistingElements = function() {
 ...
 * @private
 */
Graphics$1._createErrorPrinter = function() {
 ...
 * @private
 */
Graphics$1._updateErrorPrinter = function() {
 ...
 * @private
 */
Graphics$1._createCanvas = function() {
 ...
 * @private
 */
Graphics$1._updateCanvas = function() {
 ...
 * @private
 */
Graphics$1._createVideo = function() {
 ...
 * @private
 */
Graphics$1._updateVideo = function() {
 ...
 * @private
 */
Graphics$1._createUpperCanvas = function() {
 ...
 * @private
 */
Graphics$1._updateUpperCanvas = function() {
 ...
 * @private
 */
Graphics$1._clearUpperCanvas = function() {
 ...
 * @private
 */
Graphics$1._paintUpperCanvas = function() {
    this._clearUpperCanvas();
 ...
 * @private
 */
Graphics$1._createRenderer = function() {
 ...
 * @private
 */
Graphics$1._updateRenderer = function() {
    if (this._renderer) {
 ...
 * @private
 */
Graphics$1._createFPSMeter = function() {
 ...
 * @private
 */
Graphics$1._createModeBox = function() {
 ...
 * @private
 */
Graphics$1._createGameFontLoader = function() {
 ...
 * @private
 */
Graphics$1._createFontLoader = function(name) {
 ...
 * @private
 */
Graphics$1._centerElement = function(element) {
 ...
 * @private
 */
Graphics$1._disableTextSelection = function() {
 ...
 * @private
 */
Graphics$1._disableContextMenu = function() {
 ...
 * @private
 */
Graphics$1._applyCanvasFilter = function() {
    if (this._canvas) {
 ...
 * @private
 */
Graphics$1._onVideoLoad = function() {
    this._video.play();
 ...
 * @private
 */
Graphics$1._onVideoError = function() {
 ...
 * @private
 */
Graphics$1._onVideoEnd = function() {
    this._updateVisibility(false);
};
 ...
 * @private
 */
Graphics$1._updateVisibility = function(videoVisible) {
 ...
 * @private
 */
Graphics$1._isVideoVisible = function() {
 ...
 * @private
 */
Graphics$1._setupEventHandlers = function() {
 ...
 * @private
 */
Graphics$1._onWindowResize = function() {
    this._updateAllElements();
};
 ...
 * @private
 */
Graphics$1._onKeyDown = function(event) {
 ...
 * @private
 */
Graphics$1._onTouchEnd = function(event) {
 ...
 * @private
 */
Graphics$1._switchFPSMeter = function() {
 ...
 * @private
 */
Graphics$1._switchStretchMode = function() {
 ...
 * @private
 */
Graphics$1._switchFullScreen = function() {
 ...
 * @private
 */
Graphics$1._isFullScreen = function() {
 ...
 * @private
 */
Graphics$1._requestFullScreen = function() {
 ...
 * @private
 */
Graphics$1._cancelFullScreen = function() {
...
Decrypter.decryptImg = function(url, bitmap) {
    ...
    requestFile.onload = function () {
        if(this.status < Decrypter._xhrOk) {
            ...
            bitmap._image.addEventListener('load', bitmap._loadListener = Bitmap$1.prototype._onLoad.bind(bitmap));
            bitmap._image.addEventListener('error', bitmap._errorListener = bitmap._loader || Bitmap$1.prototype._onError.bind(bitmap));
        }
    };
...
Bitmap$1.prototype._createCanvas = function(width, height){
...
Bitmap$1.prototype._createBaseTexture = function(source){
...
Bitmap$1.prototype._clearImgInstance = function(){
    this._image.src = "";
    ...
    Bitmap$1._reuseImages.push(this._image);
    this._image = null;
};
...
//
Object.defineProperties(Bitmap$1.prototype, {
    _canvas: {
        get: function(){
...
Bitmap$1.prototype._renewCanvas = function(){
...
Bitmap$1.prototype.initialize = function(width, height) {
    if(!this._defer){
 ...
 * @return Bitmap
 */
Bitmap$1.load = function(url) {
    var bitmap = Object.create(Bitmap$1.prototype);
    bitmap._defer = true;
    bitmap.initialize();
 ...
 * @return Bitmap
 */
Bitmap$1.snap = function(stage) {
    var width = Graphics$1.width;
    var height = Graphics$1.height;
    var bitmap = new Bitmap$1(width, height);
    var context = bitmap._context;
    var renderTexture = PIXI.RenderTexture.create(width, height);
    if (stage) {
        Graphics$1._renderer.render(stage, renderTexture);
        stage.worldTransform.identity();
        var canvas = null;
        if (Graphics$1.isWebGL()) {
            canvas = Graphics$1._renderer.extract.canvas(renderTexture);
        } else {
 ...
 */
Bitmap$1.prototype.isReady = function() {
 ...
 */
Bitmap$1.prototype.isError = function() {
 ...
 * @method touch
 */
Bitmap$1.prototype.touch = function() {
    if (this.cacheEntry) {
 ...
 * @type String
 */
Object.defineProperty(Bitmap$1.prototype, 'url', {
    get: function() {
        return this._url;
    },
    configurable: true
 ...
 */
Object.defineProperty(Bitmap$1.prototype, 'baseTexture', {
    get: function() {
 ...
 */
Object.defineProperty(Bitmap$1.prototype, 'canvas', {
    get: function() {
        return this._canvas;
    },
    configurable: true
 ...
 */
Object.defineProperty(Bitmap$1.prototype, 'context', {
    get: function() {
 ...
 * @type Number
 */
Object.defineProperty(Bitmap$1.prototype, 'width', {
    get: function() {
        if(this.isReady()){
 ...
 * @type Number
 */
Object.defineProperty(Bitmap$1.prototype, 'height', {
    get: function() {
        if(this.isReady()){
 ...
 * @type Rectangle
 */
Object.defineProperty(Bitmap$1.prototype, 'rect', {
    get: function() {
 ...
 * @type Boolean
 */
Object.defineProperty(Bitmap$1.prototype, 'smooth', {
    get: function() {
        return this._smooth;
    },
    set: function(value) {
 ...
 * @type Number
 */
Object.defineProperty(Bitmap$1.prototype, 'paintOpacity', {
    get: function() {
 ...
 */
Bitmap$1.prototype.resize = function(width, height) {
 ...
 */
Bitmap$1.prototype.blt = function(source, sx, sy, sw, sh, dx, dy, dw, dh) {
    dw = dw || sw;
    dh = dh || sh;
 ...
 * @param {Number} [dh=sh] The height to draw the image in the destination
 */
Bitmap$1.prototype.bltImage = function(source, sx, sy, sw, sh, dx, dy, dw, dh) {
    dw = dw || sw;
    dh = dh || sh;
    if (sx >= 0 && sy >= 0 && sw > 0 && sh > 0 && dw > 0 && dh > 0 &&
        sx + sw <= source.width && sy + sh <= source.height) {
 ...
 */
Bitmap$1.prototype.getPixel = function(x, y) {
 ...
 */
Bitmap$1.prototype.getAlphaPixel = function(x, y) {
    var data = this._context.getImageData(x, y, 1, 1).data;
    return data[3];
};
 ...
 */
Bitmap$1.prototype.clearRect = function(x, y, width, height) {
 ...
 * @method clear
 */
Bitmap$1.prototype.clear = function() {
 ...
 */
Bitmap$1.prototype.fillRect = function(x, y, width, height, color) {
 ...
 * @param {String} color The color of the rectangle in CSS format
 */
Bitmap$1.prototype.fillAll = function(color) {
 ...
 */
Bitmap$1.prototype.gradientFillRect = function(x, y, width, height, color1,
                                             color2, vertical) {
    var context = this._context;
    var grad;
    if (vertical) {
 ...
 */
Bitmap$1.prototype.drawCircle = function(x, y, radius, color) {
    var context = this._context;
    context.save();
    context.fillStyle = color;
    context.beginPath();
 ...
 */
Bitmap$1.prototype.drawText = function(text, x, y, maxWidth, lineHeight, align) {
 ...
 */
Bitmap$1.prototype.measureTextWidth = function(text) {
    var context = this._context;
    context.save();
    context.font = this._makeFontNameText();
 ...
 */
Bitmap$1.prototype.adjustTone = function(r, g, b) {
 ...
 */
Bitmap$1.prototype.rotateHue = function(offset) {
 ...
 * @method blur
 */
Bitmap$1.prototype.blur = function() {
    for (var i = 0; i < 2; i++) {
        var w = this.width;
        var h = this.height;
 ...
 */
Bitmap$1.prototype.addLoadListener = function(listner) {
    if (!this.isReady()) {
 ...
 * @private
 */
Bitmap$1.prototype._makeFontNameText = function() {
 ...
 * @private
 */
Bitmap$1.prototype._drawTextOutline = function(text, tx, ty, maxWidth) {
    var context = this._context;
 ...
 * @private
 */
Bitmap$1.prototype._drawTextBody = function(text, tx, ty, maxWidth) {
    var context = this._context;
 ...
 * @private
 */
Bitmap$1.prototype._onLoad = function() {
...
Bitmap$1.prototype.decode = function(){
    switch(this._loadingState){
        ...
        case 'requesting': case 'decrypting':
            ...
            if (!this._loader) {
                this._loader = ResourceHandler$1.createLoader(this._url, this._requestImage.bind(this, this._url), this._onError.bind(this));
                this._image.removeEventListener('error', this._errorListener);
 ...
 * @private
 */
Bitmap$1.prototype._callLoadListeners = function() {
 ...
 * @private
 */
Bitmap$1.prototype._onError = function() {
    this._image.removeEventListener('load', this._loadListener);
    this._image.removeEventListener('error', this._errorListener);
 ...
 * @private
 */
Bitmap$1.prototype._setDirty = function() {
    this._dirty = true;
};
 ...
 * @method checkDirty
 */
Bitmap$1.prototype.checkDirty = function() {
    if (this._dirty) {
...
Bitmap$1.prototype._requestImage = function(url){
    if(Bitmap$1._reuseImages.length !== 0){
        this._image = Bitmap$1._reuseImages.pop();
    }else {
        this._image = new Image();
    }

    if (this._decodeAfterRequest && !this._loader) {
        this._loader = ResourceHandler$1.createLoader(url, this._requestImage.bind(this, url), this._onError.bind(this));
    }
    ...
    if(!Decrypter.checkImgIgnore(url) && Decrypter.hasEncryptedImages) {
        ...
        this._image.addEventListener('load', this._loadListener = Bitmap$1.prototype._onLoad.bind(this));
        this._image.addEventListener('error', this._errorListener = this._loader || Bitmap$1.prototype._onError.bind(this));
    }
};

Bitmap$1.prototype.isRequestOnly = function(){
    return !(this._decodeAfterRequest || this.isReady());
};

Bitmap$1.prototype.isRequestReady = function(){
    return this._loadingState !== 'pending' &&
        this._loadingState !== 'requesting' &&
        this._loadingState !== 'decrypting';
};

Bitmap$1.prototype.startRequest = function(){
...
Input._onKeyDown = function(event) {
    ...
    if (ResourceHandler$1.exists() && buttonName === 'ok') {
        ResourceHandler$1.retry();
    } else if (buttonName) {
...
TouchInput._onLeftButtonDown = function(event) {
    var x = Graphics$1.pageToCanvasX(event.pageX);
    var y = Graphics$1.pageToCanvasY(event.pageY);
...
TouchInput._onTouchStart = function(event) {
    for (var i = 0; i < event.changedTouches.length; i++) {
        ...
        var x = Graphics$1.pageToCanvasX(touch.pageX);
        var y = Graphics$1.pageToCanvasY(touch.pageY);
        if (Graphics$1.isInsideCanvas(x, y)) {
...
Sprite$1.prototype = Object.create(PIXI.Sprite.prototype);
Sprite$1.prototype.constructor = Sprite$1;

Sprite$1.voidFilter = new PIXI.filters.VoidFilter();

Sprite$1.prototype.initialize = function(bitmap) {
    ...
    this.spriteId = Sprite$1._counter++;
    this.opaque = false;
 ...
 * @type Bitmap
 */
Object.defineProperty(Sprite$1.prototype, 'bitmap', {
    get: function() {
        return this._bitmap;
    },
    set: function(value) {
 ...
 * @type Number
 */
Object.defineProperty(Sprite$1.prototype, 'width', {
    get: function() {
 ...
 * @type Number
 */
Object.defineProperty(Sprite$1.prototype, 'height', {
    get: function() {
 ...
 * @type Number
 */
Object.defineProperty(Sprite$1.prototype, 'opacity', {
    get: function() {
 ...
 * @method update
 */
Sprite$1.prototype.update = function() {
 ...
 */
Sprite$1.prototype.move = function(x, y) {
    this.x = x;
    this.y = y;
};
 ...
 */
Sprite$1.prototype.setFrame = function(x, y, width, height) {
    this._refreshFrame = false;
 ...
 */
Sprite$1.prototype.getBlendColor = function() {
 ...
 */
Sprite$1.prototype.setBlendColor = function(color) {
 ...
 */
Sprite$1.prototype.getColorTone = function() {
 ...
 */
Sprite$1.prototype.setColorTone = function(tone) {
 ...
 * @private
 */
Sprite$1.prototype._onBitmapLoad = function(bitmapLoaded) {
 ...
 * @private
 */
Sprite$1.prototype._refresh = function() {
 ...
 * @private
 */
Sprite$1.prototype._isInBitmapRect = function(x, y, w, h) {
 ...
 * @private
 */
Sprite$1.prototype._needsTint = function() {
 ...
 * @private
 */
Sprite$1.prototype._createTinter = function(w, h) {
    if (!this._canvas) {
        this._canvas = document.createElement('canvas');
 ...
 * @private
 */
Sprite$1.prototype._executeTint = function(x, y, w, h) {
    var context = this._context;
    var tone = this._colorTone;
...
Sprite$1.prototype._renderCanvas_PIXI = PIXI.Sprite.prototype._renderCanvas;
Sprite$1.prototype._renderWebGL_PIXI = PIXI.Sprite.prototype._renderWebGL;
 ...
 * @private
 */
Sprite$1.prototype._renderCanvas = function(renderer) {
    if (this.bitmap) {
        this.bitmap.touch();
    }
 ...
 * @private
 */
Sprite$1.prototype._speedUpCustomBlendModes = function(renderer) {
        ...
        if (picture.drawModes[blend]) {
            ...
            if (!f || !f[0]) {
                setTimeout(function () {
                    var f = stage._filters;
                    if (!f || !f[0]) {
                        stage.filters = [Sprite$1.voidFilter];
                        stage.filterArea = new PIXI.Rectangle(0, 0, Graphics$1.width, Graphics$1.height);
                    }
                }, 0);
            }
        }
 ...
 * @private
 */
Sprite$1.prototype._renderWebGL = function(renderer) {
    if (this.bitmap) {
        this.bitmap.touch();
    }
    if(this.bitmap && !this.bitmap.isReady()){
...
// PIXI.tilemap.TileRenderer.SCALE_MODE = 'nearest'; // PIXI.SCALE_MODES.NEAREST;
PIXI.tilemap.settings.TEXTILE_SCALE_MODE = 'nearest'; // PIXI.SCALE_MODES.NEAREST;
 ...
 */
TilingSprite = class extends PIXI.TilingSprite {
    /** @type {Point} */
    tilePosition;
    /** @type {Point} */
	origin;
...
TilingSprite.prototype.updateTransformTS = PIXI.TilingSprite.prototype.updateTransform; // PIXI.extras.TilingSprite.prototype.updateTransform;
...
TilingSprite.prototype._speedUpCustomBlendModes = Sprite$1.prototype._speedUpCustomBlendModes;
...
Window.prototype._createAllParts = function() {
    ...
    this._windowBackSprite = new Sprite$1();
    this._windowCursorSprite = new Sprite$1();
    this._windowFrameSprite = new Sprite$1();
    this._windowContentsSprite = new Sprite$1();
    this._downArrowSprite = new Sprite$1();
    this._upArrowSprite = new Sprite$1();
    this._windowPauseSignSprite = new Sprite$1();
    this._windowBackSprite.bitmap = new Bitmap$1(1, 1);
...
WindowLayer.prototype.renderCanvas = function(renderer) {
    ...
    this._tempCanvas.width = Graphics$1.width;
    this._tempCanvas.height = Graphics$1.height;

    var realCanvasContext = renderer.context;
    var context = this._tempCanvas.getContext('2d');

    context.save();
    context.clearRect(0, 0, Graphics$1.width, Graphics$1.height);
    context.beginPath();
...
Weather.prototype._createBitmaps = function() {
    this._rainBitmap = new Bitmap$1(1, 60);
    this._rainBitmap.fillAll('white');
    this._stormBitmap = new Bitmap$1(2, 100);
    this._stormBitmap.fillAll('white');
    this._snowBitmap = new Bitmap$1(9, 9);
...
Weather.prototype._addSprite = function() {
    var sprite = new Sprite$1(this.viewport);
    sprite.opacity = 0;
