...
Bitmap.prototype._createBaseTexture = function(source){
    ...
    // const imageSource = new PIXI.ImageSource({
    //     resource: source,
    //     scaleMode: this._smooth ? 'linear' : 'nearest',
    // });

    // this.__texture = new PIXI.Texture({
    //     source: imageSource,
    //     // mipmap: false, // Equivalent to disabling mipmaps
    // });

    // this.__texture.width = source.width;
    // this.__texture.height = source.height;
